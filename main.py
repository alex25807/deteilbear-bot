...
GREETING_KEYBOARD = InlineKeyboardMarkup([
    ...
    [
        ...
        InlineKeyboardButton("🎁 Приветственный бонус", callback_data="menu_bonus"),
    ],
    [
...
TOPIC_LABELS = {
    ...
    "sub_shop_discounts": "скидками на автохимию",
    ...
    "menu_bonus": "приветственным бонусом",
    "menu_portfolio": "примерами работ",
    "menu_discounts": "скидками и акциями",
}
...
MENU_PROMPTS = {
    ...
    "menu_bonus": "Есть ли бонус для новых клиентов? Расскажите про приветственный бонус",
    "menu_portfolio": "Где посмотреть примеры ваших работ? Покажите примеры",
    "menu_discounts": "Какие у вас скидки и промокоды? Есть ли акции?",
    ...
    "sub_shop_discounts": "Есть ли скидки на автохимию? Какие промокоды действуют?",
    # Подменю: комфорт
...
• Пример: «Отлично! Записаться можно по кнопке ниже ⬇️ Администратор подберёт удобное время и расскажет про приветственный бонус! [ЗАПИСЬ]»
...
«Отлично! Записаться можно по кнопке ниже ⬇️ Администратор подберёт удобное время, уточнит стоимость и расскажет про приветственный бонус для новых клиентов! [ЗАПИСЬ]»
